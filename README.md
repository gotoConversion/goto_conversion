...
- :bar_chart: [Outperforms Market with +10% Yield](https://pyckio.com/i/#!account/gotoconversion) :tennis:
- :microphone: [Presentation at the Royal Statistical Society](https://youtu.be/M00osEjcp_4?si=_WZv09311q3UoS9t&t=411) :book:

# Ease of Use

To use `goto_conversion`, it does not require historical data for fitting, advanced domain knowledge, nor paid computational resources.
